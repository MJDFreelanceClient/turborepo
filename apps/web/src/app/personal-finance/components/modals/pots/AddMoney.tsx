...
export const AddMoney = () => {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger className={`bg-beige-100 flex-1 rounded-[8px] py-4 cursor-pointer`}>+ Add Money</DialogTrigger>
                <DialogContent className={`bg-white ${colors.setup} ${text.setup} flex flex-col-gap-5 p-5`}>
                    <DialogHeader className={`text-left flex flex-col gap-5`}>
                        <DialogTitle className={`text-preset-1 text-gray-900 font-bold`}>Add Money</DialogTitle>
